...
# 🧠 Memory Cell: Split-Turn Operational Architecture (v2.0.0)

이 셀은 ODD Kit의 심장부이며, 지식의 생성(Order)과 보존(Memory)의 선순환 구조를 정의한다.
...
- **Action**: 관리된 `memory/cells/`의 내용을 기반으로 `docs/specs/` 및 `odd-kit-prompt-template/` 문서를 역으로 업데이트.
...
- `.odd-kit/memory/cells/tech/odd-kit-turn-system.md`
- `.odd-kit/memory/cells/tech/odd-kit-evolution-log.md`
