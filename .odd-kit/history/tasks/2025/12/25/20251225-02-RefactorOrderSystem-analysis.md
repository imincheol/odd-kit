...
2. **주석의 부재**: 템플릿 파일(`template/order.json`)에 가이드를 주석으로 달 수 없어, 별도의 설명서가 필요하거나 필드명으로 유추해야 합니다.
...
| :--- | :--- | :--- | :--- | :--- |
| **작업 (Tasks)** | `tasks/template/` | JSON | **Markdown** | **[교체]** 가이드와 주석이 필수적인 템플릿은 MD로 전면 교체합니다. |
