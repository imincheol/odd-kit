...
- 판단된 결과에 따라 AI에게 건네줄 다음 가이드(`ODD-KIT-INIT.md` 또는 `ODD-KIT-MIGRATION.md`)를 맞춤형으로 안내.
...
- [ ] 종료 메시지(Final Message)를 상황별로 분기 처리
  - **신규(New)**: "축하합니다! `docs/odd/setup/ODD-KIT-INIT.md`를 AI에게 건네주어 프로젝트를 시작하세요."
  - **업데이트(Update)**: "성공적으로 업데이트되었습니다! 변경 사항 적용을 위해 `docs/odd/setup/ODD-KIT-MIGRATION.md`를 AI에게 건네주세요."

### B. Guide Refinement
- [ ] `ODD-KIT-INIT.md` 및 `ODD-KIT-MIGRATION.md` 상단에 사용자가 복사하기 편하도록 요약 메시지 보강
