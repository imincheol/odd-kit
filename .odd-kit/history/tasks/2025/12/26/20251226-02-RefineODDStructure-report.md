...
linked-order: "20251226-02-RefineODDStructure.md"
---
...
## 2. Artifacts (산출물)
- `docs/odd/tasks/template/order.md` (New)
- `docs/odd/tasks/template/progress.md` (New)
- `docs/odd/tasks/template/report.md` (New)
