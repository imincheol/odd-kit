...
### 🧐 Issues & Insight
1. 현재 `install.sh` 실행 후 사용자가 직접 `ODD-KIT-INIT.md`나 `ODD-KIT-MIGRATION.md` 내용을 복사하여 AI에게 전달해야 함.
...
- 생성된 오더 파일은 AI에게 `ODD-KIT-INIT.md` 또는 `ODD-KIT-MIGRATION.md`를 읽고 절차를 수행하라는 지침을 포함함.
...
### C. Sync
- [ ] `oddtemplate/setup/install.sh`에도 동일하게 반영
