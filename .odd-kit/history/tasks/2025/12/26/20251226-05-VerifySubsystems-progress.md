...
order-link: "20251226-05-VerifySubsystems.md"
---
...
- **Plan**:
    ...
    3. `-template` 폴더의 deprecated 파일 삭제.
    4. `.gitkeep` 전수 조사.
...
- **Detail**:
    - **Rename**: `odd/` -> `oddtemplate/` (Template과 Instance 분리).
    - **Sync**: `oddtemplate/` 내부 파일을 `docs/odd/`의 최신본으로 교체 (ATLAS_TEMPLATE 등).
...
- **Detail**:
    ...
    - **Cleanup**: `tasks/template/*.deprecated` 삭제 확인.
