...
context:
  ...
  - "README.md"
  - "odd-kit-template/setup/install.sh"
---
...
3. 프로젝트의 공식 명칭이 "ODD Kit"으로 확고해짐에 따라, 코드 베이스 내의 구 프로젝트 명(`odd-starter`) 참조를 갱신해야 함.
...
- [x] `odd-kit-template/setup/install.sh`: `REMOTE_SCRIPT_URL`, `REPO_URL` 변수 수정
- [x] `docs/specs/2-design/STRUCTURE.md`: 프로젝트 명칭 참조 수정
