...
linked-order: "20260103-02-CellGranularityGuideline-order.md"
---
...
- **Key Changes**:
    ...
    - **시스템 전반 통합**: ODD-KIT-PROMPT, README, memory/README에 가이드라인 참조 추가

## 2. Artifacts (산출물)
- `.odd/memory/core/cell-granularity-guideline.md` - 입자도 가이드라인 (정량/정성 기준, 분리 신호, 체크리스트)
- `.odd/memory/rules/cell_creation_protocol.md` - Cell 생성 프로토콜 (워크플로우, 시나리오, 자동화 템플릿)
- `.odd/ODD-KIT-PROMPT.md` - Turn 3에 입자도 체크 추가
...
- [x] `.odd/ODD-KIT-PROMPT.md` - Turn 3에 입자도 체크 추가
- [x] `.odd/memory/README.md` - Memory Cell 용어 및 가이드라인 링크
- [x] `README.md` - 세포화 원칙 팁 추가
- [x] `.odd/memory/core/cell-granularity-guideline.md` - 신규 생성
