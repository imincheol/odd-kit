...
summary: "ODD 아키텍처를 메타포 중심에서 기능 중심(v3: ODD_PROMPT, reference, history)으로 전면 개편"
context:
  - ".odd/ODD_PROMPT.md"
...
3. `ODD_PROMPT`, `reference`, `history` 등 핵심 키워드를 통해 시스템의 목적을 명시화함.
...
- [ ] `ATLAS_TEMPLATE.md` -> `ODD_PROMPT_TEMPLATE.md` 변경 및 내용 수정
...
- [ ] `ODD_INIT_TEMPLATE.md`, `ODD_UPDATE_TEMPLATE.md` 내용 업데이트
