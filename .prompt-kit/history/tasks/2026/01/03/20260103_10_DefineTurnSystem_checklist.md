...
## 1. Protocol Definition (`pk-template/reference/rules/pk-system.md`)
...
## 2. Local Protocol Update (`.prompt-kit/reference/rules/pk-system.md`)
현재 프로젝트(로컬)에도 동일하게 적용.
- [ ] Copy logic from `pk-template` to `.prompt-kit`.
