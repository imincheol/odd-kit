...
# 🧠 Memory Cell: Turn-Based Operational Lifecycle (v1.3.0)

이 셀은 Prompt Kit의 시간적 실행 단위인 '턴(Turn)'의 생애주기를 정의한다. 시스템은 지식의 **무결성(Turn-0/Memory)**과 **변화(Turn-Order)**를 철저히 분리하여 운용한다.
