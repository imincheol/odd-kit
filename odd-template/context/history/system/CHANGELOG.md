...
### Added
- **Multi-Project & Multi-ODD Support**: Enabled independent ODD management for FE/BE domains.
- **Interactive Configuration Discovery**: The installer now intelligently finds and migrates legacy configs.
- **Flexible Path Policy**: Full customization of ODD and Specs directory locations.
- **Template Standardization**: Implemented `_TEMPLATE.md` naming convention for system source files.

## [v0.9.4] - 2025-12-26

### Added
- **Installer UX**: Added auto-detection of environment (New Install vs. Update).
- **Automation**: Automatic generation of initial Setup/Migration Orders.
