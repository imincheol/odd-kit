...
- **No Order Mutation**: 이미 승인되어 진행 중인 오더의 **본문(🎯 Goal)**을 절대 수정하지 마십시오. 모든 변경은 Progress에 남깁니다.
...
> **에이전트에게**: 당신은 현재 ODD Kit 환경에 있습니다. 지금 바로 `{{ODD-KIT-DIR}}/tasks/active/`의 오더와 `roadmap.md`를 확인하여 다음 단계를 사용자에게 제안하십시오.