...
이 문서는 AI 협업 프레임워크인 **ODD Kit (구 ODD)**와 현대적인 다른 도구들(**Spec Kit**, **Claude Skills**)의 차이점을 분석하고, 이를 어떻게 상호보완적으로 사용하여 최상의 개발 효율을 낼 수 있는지 설명합니다.
...
2.  **이식**: 작성된 Plan을 ODD Kit의 `tasks/roadmap.md`에 이식합니다.
...
*   모든 핵심 지식과 규칙은 **ODD Kit 체계(`memory/`)**에 표준 Markdown으로 남겨두고, 각 AI 도구의 특수 기능(Spec Kit, Skills)은 이를 보강하는 수단으로 활용하십시오.
