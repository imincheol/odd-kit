...
linked_order: "20260103_03_RefineGranularityToNeuralNet_order.md"
---
...
- **Key Changes**:
    - `cell_granularity_guideline.md`를 **Neural Network Edition**으로 전면 재작성.
    - 단순히 파일을 쪼개는 것이 아니라, **관심사(Concern)**를 기준으로 분리하고 **시냅스(Relatedness)**로 연결하는 철학 확립.
    - **컨텍스트 효율성** 개념을 문서화하여 다중 파일 참조의 정당성 확보.

## 2. Artifacts
- `.odd/memory/core/cell_granularity_guideline.md` (Updated)
