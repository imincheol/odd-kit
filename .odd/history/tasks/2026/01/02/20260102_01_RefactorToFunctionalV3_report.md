...
linked_order: "20260102_01_RefactorToFunctionalV3_order.md"
---
...
- **Result**: Success
- **Key Changes**:
    - **명칭 체계 전면 개편**: "살아있는 도서관" 메타포를 제거하고 `ODD_PROMPT`, `reference`, `history` 등 기능 중심 명칭으로 변경.
    - **구조 최적화**: 
        - `ATLAS.md` -> `ODD_PROMPT.md` (진입점 명시화)
...
## 2. Artifacts (산출물)
- `odd-template/` 전체 구조 개편 (v1.1.0)
- `odd-template/setup/install.sh` (v1.1.0 Installer)
