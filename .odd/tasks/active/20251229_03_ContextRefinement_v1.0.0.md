...
context:
  ...
  - "odd-template/context/protocols/odd-system.md"
---
...
- `context/history/`와 `context/_template/`에 `history_template.md`가 중복 존재함.
...
- [ ] 중복된 `history_template.md` 제거 (`context/_template/` 하나로 단일화).
...
### B. Cleanup (청소)
- [ ] `odd-template/context/history/_template/` 삭제 (redundant).
- [ ] `odd-template/context/logic/domain/` 내의 ODD 문서 삭제 (protocols로 이관됨).
- [ ] `odd-template/context/general/` 내의 ODD 설명 문서 삭제.
